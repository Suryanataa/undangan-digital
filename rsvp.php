								...
								<form action="tambah-rsvp.php" method="post">
									<div class="card-body">
										<div class="mb-3">
											...
											<input type="text" class="form-control" id="nama-rsvp" name="nama-rsvp" placeholder="nama pengirim" />
										</div>
										<div class="mb-3">
											<label for="kehadiran" class="form-label fw-semibold">konfirmasi kehadiran:</label>
											<div class="form-check">
												<input class="form-check-input" type="radio" name="kehadiran" id="kehadiran" value="Hadir"
												<?php echo ($data=='Hadir')?'checked':'' ?>>
												<label class="form-check-label" for="kehadiran"> Hadir </label>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="radio" name="kehadiran" id="kehadiran" value="Ragu"
												<?php echo ($data=='Ragu')?'checked':'' ?>>
												<label class="form-check-label" for="kehadiran"> Ragu </label>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="radio" name="kehadiran" id="kehadiran" value="Tidak Hadir"
												<?php echo ($data=='Tidak Hadir')?'checked':'' ?>>
												<label class="form-check-label" for="kehadiran"> Tidak Hadir </label>
											</div>
										</div>
										<button type="submit" class="btn btn-coklat text-white" style="border-radius: 18px; width: 100px">kirim</button>
									</div>
								</form>
							</div>
						</div>
